...
static void mux_switch_channel1(__attribute__((unused)) MUX* p_mux);
static void mux_switch_channel2(__attribute__((unused)) MUX* p_mux);
static void mux_switch_channel3(__attribute__((unused)) MUX* p_mux);
static void mux_switch_channel4(__attribute__((unused)) MUX* p_mux);
static void mux_switch_channel5(__attribute__((unused)) MUX* p_mux);
static void mux_switch_channel6(__attribute__((unused)) MUX* p_mux);
static void mux_switch_channel7(__attribute__((unused)) MUX* p_mux);
static void mux_switch_channel8(__attribute__((unused)) MUX* p_mux);
static void mux_switch_channel9(__attribute__((unused)) MUX* p_mux);
static void mux_switch_channel10(__attribute__((unused)) MUX* p_mux);
static void mux_switch_channel11(__attribute__((unused)) MUX* p_mux);
static void mux_switch_channel12(__attribute__((unused)) MUX* p_mux);
static void mux_switch_channel13(__attribute__((unused)) MUX* p_mux);
static void mux_switch_channel14(__attribute__((unused)) MUX* p_mux);
static void mux_switch_channel15(__attribute__((unused)) MUX* p_mux);
...
static mux_act mux_switch_channel_interface[15] = {mux_switch_channel1, mux_switch_channel2, mux_switch_channel3, mux_switch_channel4, mux_switch_channel5,
...
void door_switch_init(Cabinet_app* p_ca){
...
void cell_fan_init(Cabinet_app* p_ca){
	for(uint8_t cab_id = CAB1; cab_id <= CAB15; cab_id++){
...
void ntc_init(Cabinet_app* p_ca){
	for(uint8_t cab_id = CAB1; cab_id <= CAB15; cab_id++){
...
static DOOR_STATE door1_get_state(__attribute__((unused)) IO_State* p_io){
	if(HAL_GPIO_ReadPin(DOOR_ST_PORT1_4, DOOR_ST_1) ==  GPIO_PIN_SET){
		HAL_Delay(100);
		if(HAL_GPIO_ReadPin(DOOR_ST_PORT1_4, DOOR_ST_1) == GPIO_PIN_SET){
...
DOOR_STATE door3_get_state(__attribute__((unused)) IO_State* p_io){
	if(HAL_GPIO_ReadPin(DOOR_ST_PORT1_4, DOOR_ST_3) ==  GPIO_PIN_SET){
		HAL_Delay(100);
		if(HAL_GPIO_ReadPin(DOOR_ST_PORT1_4, DOOR_ST_3) == GPIO_PIN_SET){
			return DOOR_ST_CLOSE;
		}
...
static DOOR_STATE door4_get_state(__attribute__((unused)) IO_State* p_io){
	if(HAL_GPIO_ReadPin(DOOR_ST_PORT1_4, DOOR_ST_4) ==  GPIO_PIN_SET){
		HAL_Delay(100);
		if(HAL_GPIO_ReadPin(DOOR_ST_PORT1_4, DOOR_ST_4) == GPIO_PIN_SET){
			return DOOR_ST_CLOSE;
		}
...
static DOOR_STATE door5_get_state(__attribute__((unused)) IO_State* p_io){
	if(HAL_GPIO_ReadPin(DOOR_ST_PORT5_16, DOOR_ST_5) ==  GPIO_PIN_SET){
		HAL_Delay(100);
		if(HAL_GPIO_ReadPin(DOOR_ST_PORT5_16, DOOR_ST_5) == GPIO_PIN_SET){
			return DOOR_ST_CLOSE;
		}
...
static DOOR_STATE door6_get_state(__attribute__((unused)) IO_State* p_io){
	if(HAL_GPIO_ReadPin(DOOR_ST_PORT5_16, DOOR_ST_6) ==  GPIO_PIN_SET){
		HAL_Delay(100);
		if(HAL_GPIO_ReadPin(DOOR_ST_PORT5_16, DOOR_ST_6) == GPIO_PIN_SET){
			return DOOR_ST_CLOSE;
		}
...
static DOOR_STATE door7_get_state(__attribute__((unused)) IO_State* p_io){
	if(HAL_GPIO_ReadPin(DOOR_ST_PORT5_16, DOOR_ST_7) ==  GPIO_PIN_SET){
		HAL_Delay(100);
		if(HAL_GPIO_ReadPin(DOOR_ST_PORT5_16, DOOR_ST_7) == GPIO_PIN_SET){
			return DOOR_ST_CLOSE;
		}
...
static DOOR_STATE door8_get_state(__attribute__((unused)) IO_State* p_io){
	if(HAL_GPIO_ReadPin(DOOR_ST_PORT5_16, DOOR_ST_8) ==  GPIO_PIN_SET){
		HAL_Delay(100);
		if(HAL_GPIO_ReadPin(DOOR_ST_PORT5_16, DOOR_ST_8) == GPIO_PIN_SET){
			return DOOR_ST_CLOSE;
		}
...
static DOOR_STATE door9_get_state(__attribute__((unused)) IO_State* p_io){
	if(HAL_GPIO_ReadPin(DOOR_ST_PORT5_16, DOOR_ST_9) ==  GPIO_PIN_SET){
		HAL_Delay(100);
		if(HAL_GPIO_ReadPin(DOOR_ST_PORT5_16, DOOR_ST_9) == GPIO_PIN_SET){
			return DOOR_ST_CLOSE;
		}
...
static DOOR_STATE door10_get_state(__attribute__((unused)) IO_State* p_io){
	if(HAL_GPIO_ReadPin(DOOR_ST_PORT5_16, DOOR_ST_10) ==  GPIO_PIN_SET){
		HAL_Delay(100);
		if(HAL_GPIO_ReadPin(DOOR_ST_PORT5_16, DOOR_ST_10) == GPIO_PIN_SET){
			return DOOR_ST_CLOSE;
		}
...
static DOOR_STATE door11_get_state(__attribute__((unused)) IO_State* p_io){
	if(HAL_GPIO_ReadPin(DOOR_ST_PORT5_16, DOOR_ST_11) ==  GPIO_PIN_SET){
		HAL_Delay(100);
		if(HAL_GPIO_ReadPin(DOOR_ST_PORT5_16, DOOR_ST_11) == GPIO_PIN_SET){
			return DOOR_ST_CLOSE;
		}
...
static DOOR_STATE door12_get_state(__attribute__((unused)) IO_State* p_io){
	if(HAL_GPIO_ReadPin(DOOR_ST_PORT5_16, DOOR_ST_12) ==  GPIO_PIN_SET){
		HAL_Delay(100);
		if(HAL_GPIO_ReadPin(DOOR_ST_PORT5_16, DOOR_ST_12) == GPIO_PIN_SET){
			return DOOR_ST_CLOSE;
		}
...
static DOOR_STATE door13_get_state(__attribute__((unused)) IO_State* p_io){
	if(HAL_GPIO_ReadPin(DOOR_ST_PORT5_16, DOOR_ST_13) ==  GPIO_PIN_SET){
		HAL_Delay(100);
		if(HAL_GPIO_ReadPin(DOOR_ST_PORT5_16, DOOR_ST_13) == GPIO_PIN_SET){
			return DOOR_ST_CLOSE;
		}
...
static DOOR_STATE door14_get_state(__attribute__((unused)) IO_State* p_io){
	if(HAL_GPIO_ReadPin(DOOR_ST_PORT5_16, DOOR_ST_14) ==  GPIO_PIN_SET){
		HAL_Delay(100);
		if(HAL_GPIO_ReadPin(DOOR_ST_PORT5_16, DOOR_ST_14) == GPIO_PIN_SET){
			return DOOR_ST_CLOSE;
		}
...
static DOOR_STATE door15_get_state(__attribute__((unused)) IO_State* p_io){
	if(HAL_GPIO_ReadPin(DOOR_ST_PORT5_16, DOOR_ST_15) ==  GPIO_PIN_SET){
		HAL_Delay(100);
		if(HAL_GPIO_ReadPin(DOOR_ST_PORT5_16, DOOR_ST_15) == GPIO_PIN_SET){
			return DOOR_ST_CLOSE;
		}
