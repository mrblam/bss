...
COMPONENTS=nfc afe ext_flash indicator_leds
DRIVERS= gpio exint spi timer
SERVICES=CANopen debug_print task-scheduler config_server
BOARD=
PROJECT_LIBS=
...
SRCS:= test_nfc_send_message.c ../stm32f0xx_it.c ../bms.c ../system_stm32f0xx.c
